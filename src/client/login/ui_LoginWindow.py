...
from qfluentwidgets import (BodyLabel, CheckBox, HyperlinkButton, LineEdit,
    PrimaryPushButton)
import src.client.login.rc_resource
...
"}")
        ...
        self.lineEditUsername = LineEdit(self.widget)
        ...
        self.lineEditPassword = LineEdit(self.widget)
        ...
        self.pushButtonFindPassword = HyperlinkButton(self.widget)
        self.pushButtonFindPassword.setObjectName(u"pushButtonFindPassword")

        self.verticalLayout_2.addWidget(self.pushButtonFindPassword)
    ...
    def retranslateUi(self, Form):
        ...
        self.lineEditUsername.setPlaceholderText(QCoreApplication.translate("Form", u"example@example.com", None))
        self.label_6.setText(QCoreApplication.translate("Form", u"\u5bc6\u7801", None))
        self.lineEditPassword.setPlaceholderText(QCoreApplication.translate("Form", u"\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022", None))
        self.checkBoxRemember.setText(QCoreApplication.translate("Form", u"\u8bb0\u4f4f\u5bc6\u7801", None))
        self.pushButtonLogin.setText(QCoreApplication.translate("Form", u"\u767b\u5f55", None))
        self.pushButtonFindPassword.setText(QCoreApplication.translate("Form", u"\u627e\u56de\u5bc6\u7801", None))
    # retranslateUi
