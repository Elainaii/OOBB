...
class StudentTableView(TableView):
    ...
    def show_rightmenu(self,pos):
        if self.menu is None:
            ...
            self.passwordAction = Action(FluentIcon.EDIT,'修改密码',triggered= lambda :print("修改密码"))
...
class StudentFilterMenu(TransparentDropDownPushButton):
...
class StudentCommandBar(CommandBar):
    def __init__(self,controller :AdminController,parent = None):
        ...
        self.filterMenu = StudentFilterMenu('过滤',FluentIcon.FILTER)
